...
import { getSearchEntities, getEntities } from './status-cl.reducer';
import { IStatusCl } from 'app/shared/model/status-cl.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IStatusClProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface IStatusClState {
  search: string;
}

export class StatusCl extends React.Component<IStatusClProps, IStatusClState> {
  state: IStatusClState = {
    search: ''
  };
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="status-cl-heading">
          Statuses
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new Status
          </Link>
        </h2>
        <Row>
          <Col sm="12">
