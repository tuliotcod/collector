...
import { getSearchEntities, getEntities } from './role-cl.reducer';
import { IRoleCl } from 'app/shared/model/role-cl.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IRoleClProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface IRoleClState {
  search: string;
}

export class RoleCl extends React.Component<IRoleClProps, IRoleClState> {
  state: IRoleClState = {
    search: ''
  };
