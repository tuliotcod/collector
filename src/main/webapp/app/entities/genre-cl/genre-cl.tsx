...
import { getSearchEntities, getEntities } from './genre-cl.reducer';
import { IGenreCl } from 'app/shared/model/genre-cl.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IGenreClProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface IGenreClState {
  search: string;
}

export class GenreCl extends React.Component<IGenreClProps, IGenreClState> {
  state: IGenreClState = {
    search: ''
  };
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="genre-cl-heading">
          Genres
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new Genre
          </Link>
        </h2>
        <Row>
          <Col sm="12">
