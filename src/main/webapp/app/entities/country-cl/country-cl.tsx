...
import { getSearchEntities, getEntities } from './country-cl.reducer';
import { ICountryCl } from 'app/shared/model/country-cl.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ICountryClProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface ICountryClState {
  search: string;
}

export class CountryCl extends React.Component<ICountryClProps, ICountryClState> {
  state: ICountryClState = {
    search: ''
  };
