...
import { getEntity, deleteEntity } from './country-cl.reducer';

export interface ICountryClDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}

export class CountryClDeleteDialog extends React.Component<ICountryClDeleteDialogProps> {
  componentDidMount() {
