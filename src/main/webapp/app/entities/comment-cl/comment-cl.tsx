...
import { getSearchEntities, getEntities } from './comment-cl.reducer';
import { ICommentCl } from 'app/shared/model/comment-cl.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ICommentClProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface ICommentClState {
  search: string;
}

export class CommentCl extends React.Component<ICommentClProps, ICommentClState> {
  state: ICommentClState = {
    search: ''
  };
            ...
            <tbody>
              {commentList.map((comment, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{comment.issueId ? <Link to={`issue/${comment.issueId}`}>{comment.issueId}</Link> : ''}</td>
