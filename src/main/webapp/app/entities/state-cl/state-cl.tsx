...
import { getSearchEntities, getEntities } from './state-cl.reducer';
import { IStateCl } from 'app/shared/model/state-cl.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IStateClProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface IStateClState {
  search: string;
}

export class StateCl extends React.Component<IStateClProps, IStateClState> {
  state: IStateClState = {
    search: ''
  };
