...
import { getEntity, deleteEntity } from './issue-cl.reducer';

export interface IIssueClDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}

export class IssueClDeleteDialog extends React.Component<IIssueClDeleteDialogProps> {
  componentDidMount() {
