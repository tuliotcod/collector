...
import { getSearchEntities, getEntities } from './category-cl.reducer';
import { ICategoryCl } from 'app/shared/model/category-cl.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ICategoryClProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface ICategoryClState {
  search: string;
}

export class CategoryCl extends React.Component<ICategoryClProps, ICategoryClState> {
  state: ICategoryClState = {
    search: ''
  };
