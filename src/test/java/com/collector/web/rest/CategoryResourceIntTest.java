...
import com.collector.domain.Category;
import com.collector.repository.CategoryRepository;
import com.collector.repository.search.CategorySearchRepository;
import com.collector.service.CategoryService;
import com.collector.service.dto.CategoryDTO;
import com.collector.service.mapper.CategoryMapper;
...
public class CategoryResourceIntTest {
     ...
     *
     * @see com.collector.repository.search.CategorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getDesc()).isEqualTo(DEFAULT_DESC);
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getDesc()).isEqualTo(UPDATED_DESC);
