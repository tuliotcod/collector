...
public class TeamResourceIntTest {
     ...
     *
     * @see com.collector.repository.search.TeamSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createTeam() throws Exception {
        ...
        assertThat(testTeam.getOriginalName()).isEqualTo(DEFAULT_ORIGINAL_NAME);
        assertThat(testTeam.getBio()).isEqualTo(DEFAULT_BIO);
        assertThat(testTeam.getCreationDate()).isEqualTo(DEFAULT_CREATION_DATE);
        assertThat(testTeam.getLastUpdate()).isEqualTo(DEFAULT_LAST_UPDATE);
    ...
    public void updateTeam() throws Exception {
        ...
        assertThat(testTeam.getOriginalName()).isEqualTo(UPDATED_ORIGINAL_NAME);
        assertThat(testTeam.getBio()).isEqualTo(UPDATED_BIO);
        assertThat(testTeam.getCreationDate()).isEqualTo(UPDATED_CREATION_DATE);
        assertThat(testTeam.getLastUpdate()).isEqualTo(UPDATED_LAST_UPDATE);
    ...
    public void searchTeam() throws Exception {
        // Initialize the database
        teamRepository.saveAndFlush(team);
        when(mockTeamSearchRepository.search(queryStringQuery("id:" + team.getId())))
