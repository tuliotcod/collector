...
public class ActionResourceIntTest {
     ...
     *
     * @see com.collector.repository.search.ActionSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createAction() throws Exception {
        ...
        assertThat(testAction.getDesc()).isEqualTo(DEFAULT_DESC);
    ...
    public void updateAction() throws Exception {
        ...
        Action testAction = actionList.get(actionList.size() - 1);
        assertThat(testAction.getDesc()).isEqualTo(UPDATED_DESC);
